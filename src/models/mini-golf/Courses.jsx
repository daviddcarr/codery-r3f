...
export function CourseOne(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course1.glb')

    const [ setCameraPosition ] = useMiniGolfGame(state => [state.setCameraPosition])
...
export function CourseTwo(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course2.glb')
...
export function CourseThree(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course3.glb')
...
export function CourseFour(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course4.glb')
...
export function CourseNine(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course5.glb')
...
export function CourseSeven(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course6.glb')
...
export function CourseFive(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course7.glb')
...
export function CourseSix(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course8.glb')
...
export function CourseEight(props) {
    ...
    const gltf = useGLTF('./gltf/mini-golf/Course9.glb')
